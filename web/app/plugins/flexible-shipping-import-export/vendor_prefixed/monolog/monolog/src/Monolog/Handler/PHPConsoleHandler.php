...
use FlexibleShippingImportExportVendor\Monolog\Formatter\LineFormatter;
...
use FlexibleShippingImportExportVendor\Monolog\Utils;
use FlexibleShippingImportExportVendor\PhpConsole\Connector;
use FlexibleShippingImportExportVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use FlexibleShippingImportExportVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('FlexibleShippingImportExportVendor\PhpConsole\Connector')) {
