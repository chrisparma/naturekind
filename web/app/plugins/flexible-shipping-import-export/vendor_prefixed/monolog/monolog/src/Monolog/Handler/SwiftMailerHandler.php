...
use FlexibleShippingImportExportVendor\Swift_Message;
use FlexibleShippingImportExportVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\FlexibleShippingImportExportVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
