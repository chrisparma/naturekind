...
class RedisHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($redis instanceof \FlexibleShippingImportExportVendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    protected function writeCapped(array $record): void
    {
        if ($this->redisClient instanceof \Redis) {
            $mode = defined('FlexibleShippingImportExportVendor\Redis::MULTI') ? \Redis::MULTI : 1;
