...
use FlexibleShippingImportExportVendor\Aws\Sdk;
use FlexibleShippingImportExportVendor\Aws\DynamoDb\DynamoDbClient;
use FlexibleShippingImportExportVendor\Monolog\Formatter\FormatterInterface;
use FlexibleShippingImportExportVendor\Aws\DynamoDb\Marshaler;
use FlexibleShippingImportExportVendor\Monolog\Formatter\ScalarFormatter;
...
class DynamoDbHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(DynamoDbClient $client, string $table, $level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        if (defined('FlexibleShippingImportExportVendor\Aws\Sdk::VERSION') && version_compare(Sdk::VERSION, '3.0', '>=')) {
            $this->version = 3;
