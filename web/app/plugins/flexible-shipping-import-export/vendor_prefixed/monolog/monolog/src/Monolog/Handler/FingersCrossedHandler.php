...
use FlexibleShippingImportExportVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FlexibleShippingImportExportVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
