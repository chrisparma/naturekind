...
use FlexibleShippingImportExportVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
...
use FlexibleShippingImportExportVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FlexibleShippingImportExportVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FlexibleShippingImportExportVendor\Elasticsearch\Client;
use FlexibleShippingImportExportVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FlexibleShippingImportExportVendor\Elastic\Elasticsearch\Client as Client8;
/**
