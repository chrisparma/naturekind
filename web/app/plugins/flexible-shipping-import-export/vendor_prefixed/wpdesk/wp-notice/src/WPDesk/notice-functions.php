...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \FlexibleShippingImportExportVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::notice($noticeContent, \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::notice($noticeContent, \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::notice($noticeContent, \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::notice($noticeContent, \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('FlexibleShippingImportExportVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \FlexibleShippingImportExportVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('FlexibleShippingImportExportVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
