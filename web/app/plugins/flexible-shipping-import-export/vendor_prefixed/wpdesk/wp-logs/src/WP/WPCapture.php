...
namespace FlexibleShippingImportExportVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-shipping-import-export'),
            $dir
        ), \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-shipping-import-export'),
            $file
        ), \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
