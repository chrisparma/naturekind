...
namespace FlexibleShippingImportExportVendor\WPDesk\Logger\WC;

use FlexibleShippingImportExportVendor\Monolog\Logger;
use FlexibleShippingImportExportVendor\WPDesk\Logger\WC\Exception\WCLoggerAlreadyCaptured;
/**
