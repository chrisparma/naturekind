...
if (!\class_exists('FlexibleShippingImportExportVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FlexibleShippingImportExportVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-shipping-import-export'), 'emergency' => \__('Emergency', 'flexible-shipping-import-export'), 'alert' => \__('Alert', 'flexible-shipping-import-export'), 'critical' => \__('Critical', 'flexible-shipping-import-export'), 'error' => \__('Error', 'flexible-shipping-import-export'), 'warning' => \__('Warning', 'flexible-shipping-import-export'), 'notice' => \__('Notice', 'flexible-shipping-import-export'), 'info' => \__('Info', 'flexible-shipping-import-export'), 'debug' => \__('Debug', 'flexible-shipping-import-export')];
        }
        /**
         * @param string $level
         * @param string $source
