...
use LogicException;
use FlexibleShippingImportExportVendor\Monolog\Handler\NullHandler;
use FlexibleShippingImportExportVendor\Monolog\Logger;
use FlexibleShippingImportExportVendor\Monolog\Registry;
use FlexibleShippingImportExportVendor\Monolog\Handler\StreamHandler;
use FlexibleShippingImportExportVendor\Psr\Log\LogLevel;
use FlexibleShippingImportExportVendor\WPDesk\Logger\WC\WooCommerceCapture;
use FlexibleShippingImportExportVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('FlexibleShippingImportExportVendor\WC_LOG_THRESHOLD')) {
            define('FlexibleShippingImportExportVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
