...
if (!\class_exists('FlexibleShippingImportExportVendor\Basic_Requirement_Checker')) {
    require_once __DIR__ . '/Basic_Requirement_Checker.php';
}
if (!\class_exists('FlexibleShippingImportExportVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
