...
use FlexibleShippingImportExportVendor\WPDesk\Helper\HelperRemover;
use FlexibleShippingImportExportVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use FlexibleShippingImportExportVendor\WPDesk\License\PluginRegistrator;
use FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
