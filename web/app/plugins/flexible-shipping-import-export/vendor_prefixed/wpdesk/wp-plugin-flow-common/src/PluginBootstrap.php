...
namespace FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-shipping-import-export';
     ...
     */
    private function init_translations(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FlexibleShippingImportExportVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FlexibleShippingImportExportVendor\WPDesk_Plugin_Info();
