...
namespace FlexibleShippingImportExportVendor\WPDesk\Plugin\Flow\Initialization;

use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
