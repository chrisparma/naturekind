...
namespace FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Builder;
...
use FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\FlexibleShippingImportExportVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
