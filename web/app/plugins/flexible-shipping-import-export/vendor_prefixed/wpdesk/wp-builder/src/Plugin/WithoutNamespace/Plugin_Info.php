...
if (!\interface_exists('FlexibleShippingImportExportVendor\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FlexibleShippingImportExportVendor\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FlexibleShippingImportExportVendor\WPDesk_Has_Plugin_Info')) {
