...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-shipping-import-export'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-shipping-import-export'), 'product_status' => \__('Subscription Status', 'flexible-shipping-import-export'), 'product_license' => \__('Subscription Data', 'flexible-shipping-import-export')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-shipping-import-export');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-shipping-import-export');
        }
        return $status;
    }
