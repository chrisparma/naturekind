...
class PluginRegistrator implements PluginRegistratorInterface
{
    ...
    {
        if (\FlexibleShippingImportExportVendor\WPDesk\License\LicenseServer\PluginRegistrator::should_use_license_server()) {
            $this->true_registrator = new \FlexibleShippingImportExportVendor\WPDesk\License\LicenseServer\PluginRegistrator($plugin_info);
        } else {
