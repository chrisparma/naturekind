...
use FlexibleShippingImportExportVendor\WPDesk\Notice\AjaxHandler;
use FlexibleShippingImportExportVendor\WPDesk\Notice\PermanentDismissibleNotice;
if (!\defined('ABSPATH')) {
    exit;
}
if (!\class_exists('FlexibleShippingImportExportVendor\WPDesk_API_Manager_With_Update_Flag')) {
    class WPDesk_API_Manager_With_Update_Flag
    {
         ...
         */
        public $text_domain = 'flexible-shipping-import-export';
        /**
         * @var string
         */
        public $plugin_url;
        ...
        public function check_external_blocking()
        {
            ...
            if (\defined('FlexibleShippingImportExportVendor\WP_HTTP_BLOCK_EXTERNAL') && \FlexibleShippingImportExportVendor\WP_HTTP_BLOCK_EXTERNAL === \true) {
                // check if our API endpoint is in the allowed hosts
                $host = \parse_url($this->upgrade_url, \PHP_URL_HOST);
                if (!\defined('FlexibleShippingImportExportVendor\WP_ACCESSIBLE_HOSTS') || \stristr(\FlexibleShippingImportExportVendor\WP_ACCESSIBLE_HOSTS, $host) === \false) {
                    ?>
                    <div class="error">
                        <p><?php 
