...
namespace FlexibleShippingImportExportVendor\WPDesk\License\Page\License\Action;

use FlexibleShippingImportExportVendor\WPDesk\License\Page\Action;
use FlexibleShippingImportExportVendor\WPDesk\License\ServerAddressRepository;
use FlexibleShippingImportExportVendor\WPDesk_API_Manager_With_Update_Flag;
/**
...
class LicenseActivation extends AbstractAction implements Action
{
    ...
    {
        $this->add_error('api_key_check_text', 'api_key_check_error', __('Connection failed to the Subscription Key API server. Try again later.', 'flexible-shipping-import-export'), 'error');
    }
    /**
    ...
    {
        $this->add_error('activate_text', 'activate_msg', __('Plugin license activated. ', 'flexible-shipping-import-export') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
