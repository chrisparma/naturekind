...
use FlexibleShippingImportExportVendor\WPDesk\License\InstalledPlugins;
/**
...
class LicensePage implements Hookable
{
    ...
    {
        add_submenu_page('wpdesk-helper', __('Subscriptions', 'flexible-shipping-import-export'), __('Subscriptions', 'flexible-shipping-import-export'), 'manage_options', self::PAGE_SLUG, [$this, 'handle_render_wpdesk_licenses_page']);
    }
    /**
    ...
    public function handle_render_wpdesk_licenses_page()
    {
        ...
        if (!class_exists('FlexibleShippingImportExportVendor\WPDesk_Helper_List_Table')) {
