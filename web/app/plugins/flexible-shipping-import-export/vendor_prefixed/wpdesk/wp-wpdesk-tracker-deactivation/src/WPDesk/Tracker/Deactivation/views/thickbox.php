...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-shipping-import-export'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			<div class="panel active" data-panel-id="reasons">
				<p><?php 
\_e('Before you proceed, please take 30 seconds to let us know what brought you to this decision. Your answers are anonymous.', 'flexible-shipping-import-export');
?></p>
...
\_e('Skip &amp; Deactivate', 'flexible-shipping-import-export');
?></a>
                </div>
...
?>><?php 
\_e('Submit &amp; Deactivate', 'flexible-shipping-import-export');
?></button>
                    <button href="#" class="button button-secondary button-close tracker-button-close"><?php 
\_e('Cancel', 'flexible-shipping-import-export');
?></button>
                </div>
