...
namespace FlexibleShippingImportExportVendor\Psr\Log\Test;

use FlexibleShippingImportExportVendor\Psr\Log\LoggerInterface;
use FlexibleShippingImportExportVendor\Psr\Log\LogLevel;
use FlexibleShippingImportExportVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FlexibleShippingImportExportVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FlexibleShippingImportExportVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FlexibleShippingImportExportVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
