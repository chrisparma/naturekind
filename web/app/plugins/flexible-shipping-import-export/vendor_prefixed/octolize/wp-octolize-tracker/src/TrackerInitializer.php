...
namespace FlexibleShippingImportExportVendor\Octolize\Tracker;

use FlexibleShippingImportExportVendor\Octolize\Tracker\DeactivationTracker\OctolizeReasonsFactory;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\OptInNotice;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplay;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAlways;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAndConditions;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterPresent;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterValue;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayOrConditions;
use FlexibleShippingImportExportVendor\Octolize\Tracker\OptInNotice\ShouldDisplayShippingMethodInstanceSettings;
...
use FlexibleShippingImportExportVendor\WPDesk\Tracker\Deactivation\PluginData;
...
use FlexibleShippingImportExportVendor\WPDesk\Tracker\PluginActionLinks;
/**
...
class TrackerInitializer implements HookableCollection
{
    ...
    public function hooks()
    {
        ...
        $tracker_consent = new \FlexibleShippingImportExportVendor\WPDesk_Tracker_Persistence_Consent();
     ...
     */
    public static function create_from_plugin_info(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
     ...
     * @return TrackerInitializer
     */
    public static function create_from_plugin_info_for_shipping_method(\FlexibleShippingImportExportVendor\WPDesk_Plugin_Info $plugin_info, string $shipping_method_id, ReasonsFactory $reasons_factory = null)
    {
        $shops = $plugin_info->get_plugin_shops();
        $shop_url = $shops[get_locale()] ?? $shops['default'] ?? 'https://octolize.com';
